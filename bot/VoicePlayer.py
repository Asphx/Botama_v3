...
class VoicePlayer:
    ...
    @commands.command(name='play', description='Play a song from a given YouTube link', pass_context=True)
    ...
    @commands.command(name='vladi', description='Play vladimir Cauchemard', pass_context=True)
